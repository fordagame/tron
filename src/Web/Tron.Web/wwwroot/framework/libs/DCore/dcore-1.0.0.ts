...
interface DSandbox {
    ...
    publish(topic: string, data: any): this; //publish async. All events will be executed not synchronously with the caller of the publish.
    publishSynchronize(topic: string, data: any): this; //publish async. All events will be executed before the caller of the publish continue.
...
namespace dcore {
    ...
    export class DefaultSandbox implements DSandbox {
         ...
         *  @param {*} [data] Optional data.
         */
        publishSynchronize(topic: string, data: any): this {
